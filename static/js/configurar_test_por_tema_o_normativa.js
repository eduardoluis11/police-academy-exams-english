/* Código JavaScript para el Template de Configurar un Nuevo Test por Tema o por Normativa.
* */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // No se debe ocultar ni las casillas con los temas, ni las casillas con las normativas NUNCA.
    ...
    //     // normativaField.style.display = 'none';
    //
    //     // No voy a ocultar nunca el campo de "tema" ni el campo de "normativa", por lo que esto no sirve.
    ...
    // I don't need any of these 2 things since the boxes with the topics and regulations are never hidden.
    // // Initial state
    // toggleFields();
    //
    // // Listen for changes
...
function updateQuestionCount(event) {
    ...
    const tipoTest = document.getElementById('tipo_de_test_tema_o_normativa').value;
